                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center gap-4">
                            <Key className="w-28 outline outline-2 group-hover:outline-lime-400  outline-offset-4 outline-transparent transition-all duration-500 group-hover:translate-y-1">
                                shift
                            </Key>
                            <Key className=" outline outline-2 group-hover:outline-lime-400  outline-offset-4 outline-transparent transition-all duration-500 group-hover:translate-y-1 delay-200">
                                alt
                            </Key>
                            <Key className=" outline outline-2 group-hover:outline-lime-400  outline-offset-4 outline-transparent transition-all duration-500 group-hover:translate-y-1 delay-300">
                                C
                            </Key>
                        </div>
                    </FeatureCard>
